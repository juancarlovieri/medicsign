...
async function queryRecordList() {
  try {
    ...
    const query_path = `${env.REACT_APP_BACKEND_URL}/doctor/list/` + user._id;
          ...
          <Row>
            <Col md="12">
              <Card className="strpied-tabled-with-hover">
                <Card.Header>
                  <Card.Title as="h4">Doctor Record List</Card.Title>
                  <p className="card-category">List of Doctor's Records</p>
                </Card.Header>
